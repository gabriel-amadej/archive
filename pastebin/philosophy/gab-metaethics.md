#### GAB LISTS THE BASIC METAETHICAL DEFINITIONS

[LIVE LINK](https://pastebin.com/3mGsF6HH) --/////-- 
[ARCHIVE LINK](https://archive.ph/V62NX) 
...
~Or express objectively true propositions.
...
~Or express true propositions about the atttidues of subjects.
...
~Or express true propositions that are 'true' relative to culture/society.
...
~Sometimes defined by saying moral propositions are neither true nor false.
...
~Or: statements statements are propositions that are sometimes true, but moral propositions are about the attittudes of this hypothetical ideal observer.
...
~Moral propositions are about God's commands (analyitic) / moral propositions are synyonmous with God's commands (synthetic).
...
**NOTE: Both versions of Divine Command Theory adopt the same form of cogntiivsm.**
...
~Moral propositions are about God's will (analyitic) / moral propositions are synonymous with God's will (synthetic).
